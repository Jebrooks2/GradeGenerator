...
class Gradebook:
    ...
    def __str__(self):
        ...
        return "Overall Mean: {} Overall median: {} Overall STDV: {}\n" \
               "Test Mean: {} Test Median: {} Test STDV: {}\n" \
               "Quiz Mean: {} Quiz Median: {} Quiz STDV: {}\n" \
               "Project Mean: {} Project Median: {} Project STDV: {}\n".format(np.mean(self.new1), np.median(self.new1),
                                                                             np.std(self.new1),
                                                                             np.mean(self.new2), np.median(self.new2),
                                                                             np.std(self.new2),
                                                                             np.mean(self.new3), np.median(self.new3),
                                                                             np.std(self.new3),
                                                                             np.mean(self.new4), np.median(self.new4),
                                                                             np.std(self.new4))
...
if __name__ == '__main__':
    ...
    Gradebook(os.path.join("SampleData", "grade book"), roster_file_path, test_files, project_files, quiz_files)
